...
const initialCheckedList = {
    checkBoxSpeaker: false,
    checkBoxInstitute: false,
    checkBoxAbout: false,
}
...
export default function NavMobile({ setOpenSideBar }) {
    ...
    const [checkList, setCheckList] = React.useState(initialCheckedList);

    const handleUpdateCheckList = (list) => {
        ...
        <NavStyles>
            <div className='link-1'>
                <div className='main-nav-link-div'>
                    ...
                    <BsChevronDown onClick={() => handleUpdateCheckList('checkBoxSpeaker')} className={` ${router.pathname === '/speakers' || router.pathname === '/performances' || router.pathname === '/exhibits' || router.pathname === '/film-programs' || router.pathname === '/inquiry-form' ? "active-link" : ''} ${checkList.checkBoxSpeaker && ('selected-icon')} icon`} />
                </div>
                {checkList.checkBoxSpeaker && (
            ...
            <div className='link-1'>
                <div className='main-nav-link-div'>
                    ...
                    <BsChevronDown onClick={() => handleUpdateCheckList('checkBoxInstitute')} className={`${router.pathname === '/institute' || router.pathname === '/e-course' || router.pathname === '/events' || router.pathname === '/summer-institute' || router.pathname === '/original-films' ? "active-icon" : ''} ${checkList.checkBoxInstitute && ('selected-icon')} icon`} />
                </div>
                {checkList.checkBoxInstitute && (
                <div className='ul-list-1'>
                    <ul>
                        <li>
            ...
            <div className='link-1' >
                <div className='main-nav-link-div'>
                    ...
                    <BsChevronDown onClick={() => handleUpdateCheckList('checkBoxAbout')} className={` ${router.pathname === '/about-us' || router.pathname === '/our-team' || router.pathname === '/faq' || router.pathname === '/sponsored-projects' || router.pathname === '/contact' ? "active-icon" : ''} ${checkList.checkBoxAbout && ('selected-icon')} icon`} />
                </div>
                {checkList.checkBoxAbout && (
                <div className='ul-list-1' >
                    <ul>
                        <li>
            ...
            <div className='main-nav-social left' >
